...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CurrentSubscription.discount_amount'
        db.add_column(u'djstripe_currentsubscription', 'discount_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'CurrentSubscription.discount_percentage'
        db.add_column(u'djstripe_currentsubscription', 'discount_percentage',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CurrentSubscription.discount_amount'
        db.delete_column(u'djstripe_currentsubscription', 'discount_amount')

        # Deleting field 'CurrentSubscription.discount_percentage'
        db.delete_column(u'djstripe_currentsubscription', 'discount_percentage')
    ...
    models = {
        ...
        u'djstripe.currentsubscription': {
            ...
            'discount_amount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'discount_percentage': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
