...
ASK_FOR_CARD_IF_SUBSCRIPTION_IS_TRIAL = safe_settings.ASK_FOR_CARD_IF_SUBSCRIPTION_IS_TRIAL

REDIRECT_IF_NOT_SUBSCRIBED = getattr(
    settings,
    "DJSTRIPE_REDIRECT_IF_NOT_SUBSCRIBED",
    "djstripe:subscribe"
)
REDIRECT_AFTER_SUBSCRIBED = getattr(
    settings,
    "DJSTRIPE_REDIRECT_AFTER_SUBSCRIBED",
    "djstripe:history"
)
